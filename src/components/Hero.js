...
export default function Hero() {
  return (
    <section className="relative overflow-hidden mt-24">
      <div className="container flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-28">
        <div className="flex flex-1  flex-col  items-center lg:items-start">
          ...
          <div className="flex justify-center flex-wrap gap-6">
            ...
            <Link href="#">
              <a className="btn btn-white hover:bg-bookmark-purple hover:text-white">
                Get in on Firefox
              </a>
            </Link>
          </div>
      ...
      <div className="hidden md:block bg-bookmark-purple rounded-l-full absolute lg:h-72 md:h-1/2 md:top-28 w-1/2 lg:top-36 right-0 lg:-right-36"></div>
    </section>
  );
}
